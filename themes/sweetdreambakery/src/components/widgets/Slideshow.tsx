              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 md:p-8">
                {(slide.headline ||
                  ...
                  <div className="p-4 md:p-8 rounded-lg max-w-3xl">
                    {slide.headline && (
                      <h2 className="text-white text-5xl md:text-6xl font-bold mb-2 md:mb-4 drop-shadow-lg">
                        {slide.headline}
                      </h2>
                    )}

                    {slide.subText && (
                      <p className="text-white text-xl md:text-2xl mb-4 md:mb-8 max-w-2xl mx-auto drop-shadow-md">
                        {slide.subText}
                      </p>
                    )}
                    ...
                    {slide.buttonText && slide.buttonLink && (
                      <a
                        ...
                        className="inline-block px-6 py-3 rounded-lg bg-white text-primary font-medium transition-all hover:opacity-90 hover:scale-105"
                        style={{
